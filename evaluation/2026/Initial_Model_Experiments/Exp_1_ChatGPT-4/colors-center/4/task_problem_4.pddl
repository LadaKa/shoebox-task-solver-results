...
; Objects: init_container, ball_red, ball_blue, ball_yellow, ball_green, bowl_red, bowl_blue, bowl_yellow, bowl_green
; No uncertainties or partially visible items

; Task goal: Move each colored ball to the matching bowl marked with the same color.