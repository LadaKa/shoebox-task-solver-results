(define (problem shoebox_example)
  ...
  (:init
    (in_init_container circle)
    (in_init_container triangle)
    (in_init_container square)
    (free pole_circle)
    (free pole_triangle)
    (free pole_square)
  )
...
; move_to_target circle pole_circle
; move_to_target triangle pole_triangle
; move_to_target square pole_square
